...
<x-app-layout>
            ...
            <div class="btn-group">
                <div class="inline-flex gap-x-2 me-4">
                    <a href="#" id="newUserButton"
                        class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent hover:bg-[#e38407] bg-[#f8b544] text-gray-700 dark:text-gray-200 focus:outline-none disabled:opacity-50 disabled:pointer-events-none">
                        <svg class="w-6 h-6 text-gray-700 dark:text-gray-200 hover:text-white" aria-hidden="true"
                    ...
                    <a href="#" id="newRoleButton"
                        class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent hover:bg-[#e38407] bg-[#f8b544] text-gray-700 dark:text-gray-200 focus:outline-none disabled:opacity-50 disabled:pointer-events-none">
                        <svg class="w-6 h-6 text-gray-700 dark:text-gray-200 d hover:text-white" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path fill-rule="evenodd"
                                d="M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12Zm11-4.243a1 1 0 1 0-2 0V11H7.757a1 1 0 1 0 0 2H11v3.243a1 1 0 1 0 2 0V13h3.243a1 1 0 1 0 0-2H13V7.757Z"
    ...
    <h6 class="mb-4 ps-3">Consultez la liste de tous les utilisateurs enregistrés
    </h6>
    <hr class="mb-4" />
    @if (session('success'))
        ...
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab"
            ...
            <li class="me-2" role="presentation">
                <button
                    ...
                    aria-controls="settings" aria-selected="false">Rôles et Permissions</button>
            </li>
        </ul>
    </div>
    <div id="default-tab-content">
        <div class="hidden p-4 rounded-lg bg-gray-100 dark:bg-gray-800  dark:bg-gradient-to-br from-gray-800 to-gray-900 text-gray-700 dark:text-gray-200 dark:text-gray-200"
            id="profile" role="tabpanel" aria-labelledby="profile-tab">
            <x-users-table :users="$users" :roles="$roles"></x-users-table>
        </div>
        <div class="hidden p-4 rounded-lg bg-gray-100 dark:bg-gray-800 dark:bg-gradient-to-br from-gray-800 to-gray-900 text-gray-200"
                ...
                <form id="new-user-form" class="p-4 md:p-5" method="post" action="{{ route('users.store') }}">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2 text-left">
                        <div class="col-span-2 flex items-center">
                            ...
                            <input type="text" name="name" id="name" class="border border-gray-300 text-gray-700 dark:text-gray-200 text-sm md:text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="John Doe" required="">
                        </div>
                        <div class="col-span-2 flex items-center">
                            <label for="email" class="block w-full mb-2 text-sm md:text-base font-medium text-black dark:text-white">Adresse mail</label>
                            <input type="email" name="email" id="email" class="border border-gray-300 text-gray-700 dark:text-gray-200 text-sm md:text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="exemple@exemple.com" required="">
                        </div>
                        <div class="col-span-2 flex items-center">
                            ...
                            <input type="text" name="password" id="password" class="w-full border border-gray-300 text-gray-700 dark:text-gray-200 text-sm md:text-base rounded-lg focus:ring-primary-600 focus:border-primary-600 block p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Tapez un mot de passe" required="">
                        </div>
                    ...
                    success: function(response) {
                        ...
                        $('#rolesTable').on('click', 'a[data-permission-id]', function(event) {
                            ...
                            Swal.fire({
                                ...
                                html: '<input id="permission-name" class="rounded-xl text-gray-700 dark:text-gray-200 dark:bg-gray-700 dark:text-gray-200" type="text" value="' +
                                    permissionName + '">',
