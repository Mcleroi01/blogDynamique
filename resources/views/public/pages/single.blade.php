...
@section('content')
    ...
    <!-- block news -->
    <div class="bg-gray-50 py-6 mt-5">
        <div class="xl:container mx-auto px-3 sm:px-4 xl:px-2">
            <div class="flex flex-row flex-wrap">
                <!-- Left -->
                <div class="flex-shrink max-w-full w-full lg:w-2/3 overflow-hidden">
                    <div class="w-full py-3 mb-3">
                        <div class="text-gray-700 dark:text-gray-100 mb-5">
                        ...
                        <div class="max-w-full w-full px-4">
                            ...
                            <div class="leading-relaxed pb-4">
                                ...
                                <figure class="text-center mb-6">
                                    <img class="max-w-full h-auto" src="{{ asset('storage/' . $article->image) }}"
                                        alt="{{ $article->titre }}">
                                </figure>
                                ...
                                <div
                                    ...
                                    <div class="my-4 text-sm">
                                        ...
                                        <time class="mr-2 md:mr-4" datetime="{{ $article->created_at }}">
                                            ...
                                            {{ $article->created_at->format('d F Y') }} <!-- Format lisible -->
                                        </time>
                                    ...
                                    <div class="hidden lg:block">
                                        <ul class="space-x-3">
                                            ...
                                            <li class="inline-block">
                                                <a target="_blank" class="hover:text-red-700"
                                                    href="https://www.facebook.com/sharer/sharer.php?u={{ route('showPublicArticle', ['article' => $article->_id, 'slug' => Str::slug($article->titre)]) }}"
                                            ...
                                            <li class="inline-block">
                                                <a target="_blank" class="hover:text-red-700"
                                                    href="https://twitter.com/intent/tweet?url={{ route('showPublicArticle', ['article' => $article->_id, 'slug' => Str::slug($article->titre)]) }}"
                                            ...
                                            <li class="inline-block">
                                                <a target="_blank" class="hover:text-red-700"
                                                    href="https://www.instagram.com/?url={{ route('showPublicArticle', ['article' => $article->_id, 'slug' => Str::slug($article->titre)]) }}"
                                ...
                                <p class="mb-5">{!! $article->contenu !!}</p>
                            ...
                            <div class="flex flex-wrap flex-row -mx-4 justify-center py-4">
                                <div class="flex-shrink max-w-full px-4 w-1/3 sm:w-1/4 md:w-1/6">
                                    <a href="#"><img
                                            ...
                                            src="https://picsum.photos/600/400/?random" alt="author"></a>
                                </div>
