                            ...
                            <div class="p-4 border border-gray-100 bg-white mb-4">
                                <div class="flex flex-row items-center">
                                    <div class="rounded-full overflow-hidden">
                                        <a href="{{ $user->name }}"><img class="border max-w-full w-20 sm:w-32"
                                    ...
                                    <div class="ml-8">
                                        ...
                                        <!-- website -->
                                        <p><a target="_blank" class="hover:text-blue-500" rel="noopener"
                                                href="https://aribudin.com">https://aribudin.com</a></p>
                                        <!--description-->
                                        <p class="hidden sm:block">Programmer, Father, Husband, I design and develop
                                            Tailwind template, founder of Tailnet</p>
                                        <!--social-->
                                        <div class="mt-2">
                                            <ul class="space-x-3">
                                                <!--facebook-->
                                                <li class="inline-block">
                                                    <a target="_blank" class="hover:text-gray-900" rel="noopener noreferrer"
                                ...
                                <div class="flex flex-row sm:block hover-img">
                                    ...
                                    <div class="py-0 sm:py-3 pl-3 sm:pl-0">
                                        <h3 class="text-lg font-bold leading-tight mb-2">
                                            <a
                                                href="{{ route('showPublicArticle', ['article' => $article->_id, 'slug' => Str::slug($article->titre)]) }}">{{ $article->titre }}</a>
                                        </h3>
                                        <p class="hidden md:block text-gray-600 leading-tight mb-1">
                                            {{ substr($article->contenu, 0, 150) }} ...</p>
                    ...
                    <div class="text-center mt-4">
                        ...
                        <nav aria-label="Page navigation">
                            <ul class="flex justify-center space-x-0">
                                <li>
                                    <a class="block relative py-3 px-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:text-gray-100 hover:bg-gray-700 dark:hover:bg-gray-700 -mr-0.5 rounded-l bg-gray-700 dark:bg-gray-700 text-gray-100"
                                        href="#" aria-label="Previous">
                                        <span aria-hidden="true">«</span>
                                    </a>
                                </li>
                                <li><a class="block relative py-3 px-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:text-gray-100 hover:bg-gray-700 dark:hover:bg-gray-700 -mr-0.5"
                                        href="#">1</a></li>
                                <li><a class="block relative py-3 px-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:text-gray-100 hover:bg-gray-700 dark:hover:bg-gray-700 -mr-0.5"
                                        href="#">2</a></li>
                                <li><a class="block relative py-3 px-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:text-gray-100 hover:bg-gray-700 dark:hover:bg-gray-700 -mr-0.5"
                                        href="#">3</a></li>
                                <li>
                                    <a class="block relative py-3 px-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:text-gray-100 hover:bg-gray-700 dark:hover:bg-gray-700 -mr-0.5 rounded-r"
