      ...
      <nav class="bg-black">
          <div class="xl:container mx-auto px-3 sm:px-4 xl:px-2">
              <div class="flex justify-between">
                  <div class="mx-w-10 text-2xl font-bold text-gray-200 flex items-center"> <span
                          class=" text-amber-500 text-4xl">F</span>uite243</div>

                  <div class="flex flex-row">
                      <!-- nav menu -->
                      <ul class="navbar hidden lg:flex lg:flex-row text-gray-400 text-sm items-center font-bold">
                          <li
                              class="relative border-l border-gray-800 hover:bg-gray-900 {{ request()->routeIs('publicArticle') ? 'bg-gray-900 text-white' : '' }}">
                              <a class="block py-3 px-6 border-b-2 border-transparent"
                                  href="{{ route('publicArticle') }}">Home</a>
                          </li>
                          <li
                              class="relative border-l border-gray-800 hover:bg-gray-900 {{ request()->is('articles/categories/Sports') ? 'bg-gray-900 text-white' : '' }}">
                              <a class="block py-3 px-6 border-b-2 border-transparent"
                                  href="{{ route('articles.byCategory', ['categoryName' => 'Sports']) }}">Sports</a>
                          </li>
                          <li
                              class="relative border-l border-gray-800 hover:bg-gray-900 {{ request()->is('articles/categories/Politique') ? 'bg-gray-900 text-white' : '' }}">
                              <a class="block py-3 px-6 border-b-2 border-transparent"
                                  href="{{ route('articles.byCategory', ['categoryName' => 'Politique']) }}">Politique</a>
                          </li>
                          <li
                              class="relative border-l border-gray-800 hover:bg-gray-900 {{ request()->is('articles/categories/Technologie') ? 'bg-gray-900 text-white' : '' }}">
                              <a class="block py-3 px-6 border-b-2 border-transparent"
                                  href="{{ route('articles.byCategory', ['categoryName' => 'Technologie']) }}">Techno</a>
                          </li>
                          <li
                              class="relative border-l border-gray-800 hover:bg-gray-900 {{ request()->is('articles/categories/Culture') ? 'bg-gray-900 text-white' : '' }}">
                              <a class="block py-3 px-6 border-b-2 border-transparent"
                                  href="{{ route('articles.byCategory', ['categoryName' => 'Culture']) }}">Culture</a>
                          </li>
                          <li
                              class="relative border-l border-gray-800 hover:bg-gray-900 {{ request()->is('articles/categories/Future') ? 'bg-gray-900 text-white' : '' }}">
                              <a class="block py-3 px-6 border-b-2 border-transparent"
                                  href="{{ route('articles.byCategory', ['categoryName' => 'Future']) }}">Future</a>
                          </li>
                          <li
                              class="relative border-l border-gray-800 hover:bg-gray-900 {{ request()->is('articles/categories/More') ? 'bg-gray-900 text-white' : '' }}">
                              <a class="block py-3 px-6 border-b-2 border-transparent"
                                  href="{{ route('articles.byCategory', ['categoryName' => 'More']) }}">More</a>
                          </li>
                      </ul>
